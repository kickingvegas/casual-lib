...
LISP_DIR=./lisp
MAIN_EL=$(LISP_DIR)/casual-lib.el
VERSION_EL=$(LISP_DIR)/casual-lib-version.el
...
bump-casual:
	...
	sed -i 's/(defconst casual-lib-version "$(VERSION)"/(defconst casual-lib-version "$(VERSION_BUMP)"/' $(VERSION_EL)
